...
function Card() {
  return (
    ...
    <main class="py-6 px-4 sm:p-6 md:py-10 md:px-8 bg-black rounded-lg">
        <div class="max-w-4xl mx-auto grid grid-cols-1 lg:max-w-5xl lg:gap-x-20 lg:grid-cols-2">
          ...
          <div class="grid gap-4 col-start-1 col-end-3 row-start-1 sm:mb-6 sm:grid-cols-4 lg:gap-6 lg:col-start-2 lg:row-end-6 lg:row-span-6 lg:mb-0">
            <img src="https://static.vecteezy.com/system/resources/previews/024/579/324/non_2x/modern-luxury-living-room-with-comfortable-sofa-and-elegant-decor-generated-by-ai-free-photo.jpg" alt="" class="w-full h-60 object-cover rounded-lg sm:h-52 sm:col-span-2 lg:col-span-full" loading="lazy" />
            <img src="https://static.vecteezy.com/system/resources/previews/024/579/324/non_2x/modern-luxury-living-room-with-comfortable-sofa-and-elegant-decor-generated-by-ai-free-photo.jpg" alt="" class="hidden w-full h-52 object-cover rounded-lg sm:block sm:col-span-2 md:col-span-1 lg:row-start-2 lg:col-span-2 lg:h-32" loading="lazy" />
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQp7kO_cHirc8QUGGc3YYpIMXen9cxUYOzE0A&s" alt="" class="hidden  w-full h-52 object-cover rounded-lg md:block lg:row-start-2 lg:col-span-2 lg:h-32" loading="lazy" />
          </div>
